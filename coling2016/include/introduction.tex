...
\begin{figure}[h]
\centering
	\subfloat[{{\footnotesize BU1 branch stats}}]{\label{Fig:BU1-branches+KL}\includegraphics[width=0.3\textwidth]{images/BU1-branches+KL}} \hspace{0.01cm}
	\subfloat[{{\footnotesize AmazonJulian branch  stats}}]{\label{Fig:amazonj-branches+KL}\includegraphics[width=0.37\textwidth]{images/AmazonJulian-branches+KL}} \hspace{0.01cm}
	\subfloat[{{\footnotesize BU2 branch stats}}]{\label{Fig:BU2-branches+KL}\includegraphics[width=0.26\textwidth]{images/BU2-branches+KL}} \hspace{0.01cm}
